...
public class NSVillagers {
  ...
  public static final VillagerType WISTERIA = VillagerTypeHelper.register(ResourceLocation.fromNamespaceAndPath(MOD_ID, "wisteria"));
  public static final VillagerType CYPRESS = VillagerTypeHelper.register(ResourceLocation.fromNamespaceAndPath(MOD_ID, "cypress"));
  public static final VillagerType ADOBE = VillagerTypeHelper.register(ResourceLocation.fromNamespaceAndPath(MOD_ID, "adobe"));
  public static final VillagerType COCONUT = VillagerTypeHelper.register(ResourceLocation.fromNamespaceAndPath(MOD_ID, "coconut"));
